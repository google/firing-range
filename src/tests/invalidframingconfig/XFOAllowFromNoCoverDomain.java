...
/** Handles setting XFO ALLOW-FROM option without a matching frame-ancestors CSP entry. */
public class XFOAllowFromNoCoverDomain extends HttpServlet {
  private static final String BASE_TEMPLATE = "xfoallowfromnocoverdomain.tmpl";
